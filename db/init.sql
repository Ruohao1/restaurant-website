...
food_price DECIMAL(19,4) NOT NULL,
...
menu_price DECIMAL(19,4) NOT NULL,
...
INSERT INTO food_types (type_id, type_title, type_code, serving_quantity, type_image) VALUES
(1, 'Entrée', 'E', 1, NULL),
(2, 'Maki', 'MA', 6, 'maki-saumon.jpg'),
(3, 'California maki', 'MC', 8, 'california-saumon-avocat'),
(4, 'Dragon roll', 'MC', 8, NULL),
(5, 'Croustillant', 'MC', 8, NULL),
(6, 'Egg roll', 'MC', 8, 'egg-roll-cheese-avocat.jpg'),
(7, 'Saumon roll', 'MC', 8, 'saumon-roll-avocat-cheese.jpg'),
(8, 'Maki printemps', 'MC', 8, 'spring-roll-saumon-avocat'),
(9, 'Maki neige', 'MC', 8, NULL),
(10, 'Sushi', 'SU', 2, 'sushi-saumon.jpg'),
(11, 'Sashimi', 'SA', 10, 'sashimi-assortiments.jpg'),
(12, 'Brochettes', 'Y', 2, 'brochette-poulet.jpg'),
(13, 'Boissons', NULL, 1, NULL),
(14, 'Bière', NULL, 1, NULL),
(15, 'Vin', NULL, 1, NULL),
(16, 'Plats chauds', 'P', 1, NULL),
(17, 'Salade Yamayoshi', 'E', 1, 'edamame.jpg');
...
(1, 1, 'E1', 'Riz nature', NULL, 1, 2, 'riz-nature.jpg'),
(2, 1, 'E2', 'Salade de choux', NULL, 1, 3, 'salade-de-choux.jpg'),
(3, 1, 'E3', 'Soupe miso', NULL, 1, 2.5, 'soupe-miso.jpg'),
(4, 1, 'E4', 'Riz cantonais', NULL, 1, 5.5, NULL),
(5, 1, 'E5', 'Riz vinaigré', NULL, 1, 3, 'riz-vinaigre.jpg'),
(6, 1, 'E6', 'Riz sauté au curry et aux crevettes', NULL, 1, 6.5, NULL),
(7, 1, 'E7', 'Gyoza', 'raviolis grillés', 6, 6, 'gyoza.jpg'),
(8, 1, 'E8', 'Raviolis aux crevettes vapeur', NULL, 6, 6, NULL),
(9, 1, 'E9', 'Nems au poulet', NULL, 6, 6.5, 'nems-poulet.jpg'),
(10, 1, 'E10', 'Tempura crevettes', NULL, NULL, 10, 'tempura-crevette.jpg'),
(11, 1, 'E11', 'Shaké tempura', 'beignet saumon', NULL, 10, NULL),
(12, 1, 'E12', 'Beignet poulet', NULL, NULL, 6.5, 'beignet-poulet.jpg'),
(13, 1, 'E13', 'Beignet fromage', NULL, 6, 6.5, NULL),
(14, 1, 'E14', 'Samoussa', NULL, 3, 5.5, NULL),

(15, 2, 'MA1', 'Maki saumon', NULL, 6, 5, 'maki-saumon.jpg'),
(16, 2, 'MA2', 'Maki thon', NULL, 6, 5.5, 'maki-thon.jpg'),
(17, 2, 'MA3', 'Maki anguille', NULL, 6, 6, NULL),
(18, 2, 'MA4', 'Maki concombre', NULL, 6, 4.5, 'maki-concombre.jpg'),
(19, 2, 'MA6', 'Maki avocat', NULL, 6, 4.5, 'maki-avocat.jpg'),
...
(27, 2, 'MA14', 'Temaki cornet au choix', 'thon, saumon, surimi, crevette, boeuf au fromage', 2, 6.5, 'temaki-saumon.jpg'),

(28, 3, 'MC1', 'California crevettes avocat mayonnaise', NULL, 8, 5.5, 'california-crevettes-avocat-mayonnaise.jpg'),
(29, 3, 'MC2', 'California saumon avocat', NULL, 8, 5.5, 'california-saumon-avocat.jpg'),
(30, 3, 'MC3', 'California surimi avocat', NULL, 8, 5.5, 'california-surimi-avocat.jpg'),
(31, 3, 'MC4', 'California thon cuit avocat mayonnaise', NULL, 8, 5.5, NULL),
(32, 3, 'MC5', 'California Nigiri Las vegas couchée d''une tranche de saumon', NULL, 8, 6.2, 'california-nigiri.jpg'),
(33, 3, 'MC6', 'California croustillant poulet beignet', NULL, 8, 6, NULL),
(34, 3, 'MC7', 'California tempura crevettes', NULL, 8, 7, 'california-tempura-crevette.jpg'),
(35, 3, 'MC9', 'California coriandre thon cuit', NULL, 8, 6.5, NULL),
(36, 3, 'MC10', 'California Las vegas à la sauce épicée', NULL, 8, 6.5, 'california-nigiri.jpg'),
...
(43, 6, 'MC18', 'Egg roll cheese avocat', NULL, 8, 7, 'egg-roll-cheese-avocat.jpg'),
...
(47, 7, 'MC22', 'Saumon roll fromage', NULL, 8, 7, 'saumon-roll-cheese.jpg'),
(48, 7, 'MC23', 'Saumon roll fromage avocat', NULL, 8, 7.5, 'saumon-roll-avocat-cheese.jpg'),
...
(52, 8, 'MC27', 'Maki printemps fromage saumon', NULL, 8, 6.5, 'spring-roll-saumon-cheese.jpg'),
(53, 8, 'MC28', 'Maki printemps thon rouge avocat', NULL, 8, 7, 'spring-roll-thon-avocat.jpg'),
(54, 8, 'MC29', 'Maki printemps crevettes avocat', NULL, 8, 7, NULL),
(55, 8, 'MC30', 'Maki printemps thon cuit', NULL, 8, 7, 'spring-roll-thon-cuit-avocat.jpg'),
...
(62, 10, 'SU1', 'Sushi saumon', NULL, 2, 4.5, 'sushi-saumon.jpg'),
(63, 10, 'SU2', 'Sushi thon', NULL, 2, 4.5, 'sushi-thon.jpg'),
(64, 10, 'SU3', 'Sushi daurade', NULL, 2, 4.5, 'sushi-daurade.jpg'),
(65, 10, 'SU4', 'Sushi avocat', NULL, 2, 4.5, 'sushi-avocat.jpg'),
(66, 10, 'SU5', 'Sushi maquereau', NULL, 2, 4.5, NULL),
(67, 10, 'SU6', 'Sushi crevette', NULL, 2, 5, 'sushi-crevette.jpg'),
(68, 10, 'SU7', 'Sushi poulpe', NULL, 2, 5.5, 'sushi-poulpe.jpg'),
...
(72, 10, 'SU11', 'Sushi saumon avocat', NULL, 2, 5, 'sushi-saumon-avocat.jpg'),

(73, 11, 'SA1', 'Sashimi saumon', NULL, 10, 8, 'sashimi-saumon.jpg'),
(74, 11, 'SA2', 'Sashimi thon', NULL, 10, 8.5, 'sashimi-thon.jpg'),
(75, 11, 'SA3', 'Sashimi daurade', NULL, 10, 8, 'sashimi-daurade.jpg'),
(76, 11, 'SA4', 'Sashimi maquereau', NULL, 10, 7, NULL),
(77, 11, 'SA5', 'Sashimi poulpe', NULL, 10, 11, 'sashimi-poulpe.jpg'),
(78, 11, 'SA6', 'Sashimi anguille grillée', NULL, 10, 11, NULL),
(79, 11, 'SA7', 'Assortiment de sashimi', NULL, 12, 11, 'sashimi-assortiments.jpg'),

(80, 12, 'Y1', 'Brochette poulet', NULL, 2, 4, 'brochette-poulet.jpg'),
(81, 12, 'Y2', 'Brochette boulettes de poulet', NULL, 2, 4, 'brochette-boulettes-poulet.jpg'),
(82, 12, 'Y3', 'Brochette aile de poulet', NULL, 2, 5, 'brochette-aile-de-poulet.jpg'),
(83, 12, 'Y4', 'Brochette boeuf', NULL, 2, 4.8, 'brochette-boeuf.jpg'),
(84, 12, 'Y5', 'Brochette boeuf au fromage', NULL, 2, 4.5, 'brochette-boeuf-fromage.jpg'),
(85, 12, 'Y6', 'Brochette maquereau', NULL, 2, 5.3, NULL),
(86, 12, 'Y7', 'Brochette gambas', NULL, 2, 6, 'brochette-gambas.jpg'),
(87, 12, 'Y9', 'Brochette saumon', NULL, 2, 5.5, 'brochette-saumon.jpg'),
(88, 12, 'Y10', 'Brochette thon', NULL, 2, 5.5, 'brochette-thon.jpg'),
(89, 12, 'Y11', 'Brochette champignons', NULL, 2, 4, 'brochette-champignons.jpg'),
...
(103, 16, 'P2', 'Bobun', 'vermicelle de riz, boeuf, nems, salade variée', 1, 9, 'bobun.jpeg'),
...
(107, 16, 'P6', 'Boeuf sauté aux oignons', NULL, 1, 8, 'saute-boeuf.jpeg'),
...
(113, 17, 'E15', 'Edamame', 'fève d''haricot', 1, 4.5, 'edamame.jpg'),
(114, 17, 'E16', 'Salade d''algue piquante', NULL, 1, 4.5, 'salade-dalgue.jpg'),
...
(119, 3, NULL, 'California thon avocat', NULL, 8, 5.5, 'california-thon-avocat.jpg'),
...
(1, 1, 'E1', 'Riz nature', NULL, 2, 'riz-nature.jpg'),
(2, 1, 'E2', 'Salade de choux', NULL, 3, 'salade-de-choux.jpg'),
(3, 1, 'E3', 'Soupe miso', NULL, 2.5, 'soupe-miso.jpg'),
(4, 1, 'E4', 'Riz cantonais', NULL, 5.5, NULL),
(5, 1, 'E5', 'Riz vinaigré', NULL, 3, 'riz-vinaigre.jpg'),
(6, 1, 'E6', 'Riz sauté au curry et aux crevettes', NULL, 6.5, NULL),
(7, 1, 'E7', 'Gyoza', 'raviolis grillés', 6, 'gyoza.jpg'),
(8, 1, 'E8', 'Raviolis aux crevettes vapeur', NULL, 6, NULL),
(9, 1, 'E9', 'Nems au poulet', NULL, 6.5, 'nems-poulet.jpg'),
(10, 1, 'E10', 'Tempura crevettes', NULL, 10, 'tempura-crevette.jpg'),
...
(15, 1, 'MA1', 'Maki saumon', NULL, 5, 'maki-saumon.jpg'),
(16, 1, 'MA2', 'Maki thon', NULL, 5.5, 'maki-thon.jpg'),
(17, 1, 'MA3', 'Maki anguille', NULL, 6, NULL),
(18, 1, 'MA4', 'Maki concombre', NULL, 4.5, 'maki-concombre.jpg'),
(19, 1, 'MA6', 'Maki avocat', NULL, 4.5, 'maki-avocat.jpg'),
...
(135, 4, 'PK1', 'Poké au poulet', 'Garnitures : Riz vinaigré, carotte rapée, concombre, edamame, oignons frits, poulet frits', 14.9, 'poke-bowl-poulet.jpg'),
(136, 4, 'PK2', 'Poké au boeuf', 'Garnitures : Riz vinaigré, carotte rapée, concombre, edamame, oignons frits, boeuf sauté', 14.9, 'poke-bowl-boeuf.jpg'),
(137, 4, 'PK3', 'Poké au saumon', 'Garnitures : Riz vinaigré, carotte rapée, avocat, algue marinée, omelette, saumon cru', 14.9, 'poke-bowl-saumon.jpg'),
(138, 4, 'PK4', 'Poké végétarien', 'Garnitures : Riz vinaigré, carotte rapée, concombre, edamame, radis jaune mariné, avocat, algue marinée', 13.5, 'poke-bowl-vegetarien.jpg'),
